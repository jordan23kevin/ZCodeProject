...
| 模板 | 方法 | 参数 |
|------|------|------|
| `W3.psd` | legacy | `target_height=677`, `top_y=449`, `center_x=735`, `blend_mode=multiply` |
| `W4.png` | transform | `scale=0.40`, `rotation_degrees=1.0`（顺时针 1°）, `effective_top_y=490`, `effective_center_x=780`, `blend_mode=multiply` |
