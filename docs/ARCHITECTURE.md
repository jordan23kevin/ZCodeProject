...
| 模板 | 方法 | 参数 |
|------|------|------|
| `W3.psd` | transform | `scale=0.40`, `rotation_degrees=0`, `effective_top_y=440`, `effective_center_x=730`, `blend_mode=multiply` |
| `1B.png` | transform | `scale=0.40`, `rotation_degrees=0`, `effective_top_y=725`, `effective_center_x=649`, `blend_mode=multiply` |
| `3B.png` | transform | `scale=0.32`, `rotation_degrees=-3.0`（逆时针 3°）, `effective_top_y=700`, `effective_center_x=777`, `blend_mode=multiply` |
| `4B.png` | transform | `scale=0.28`, `rotation_degrees=2.0`（顺时针 2°）, `effective_top_y=1011`, `effective_center_x=576`, `blend_mode=multiply` |
| `白正2.jpg` | transform | `scale=0.20`, `rotation_degrees=-1.0`（逆时针 1°）, `effective_top_y=644`, `effective_center_x=670`, `blend_mode=multiply` |
